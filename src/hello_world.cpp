...
int main(int argc, char **argv)
{
    ...
    // unbind vertex buffer and vertex array because we already binded and registered the
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(VAO); // not needed to bind every frame since we have only one
